  ...
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 dark:focus:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        success:
          "bg-emerald-500 text-white hover:bg-emerald-500/80 dark:bg-emerald-700",
        warning:
          "bg-amber-500 text-white hover:bg-amber-500/80 dark:bg-amber-700",
        info:
          "bg-blue-500 text-white hover:bg-blue-500/80 dark:bg-blue-700",
      },
    },
    defaultVariants: {
      variant: "default",
