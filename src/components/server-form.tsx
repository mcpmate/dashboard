...
const serverFormSchema = z.object({
  name: z.string().min(1, 'Server name cannot be empty').max(50, 'Server name cannot exceed 50 characters'),
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure server connection information. Different types of servers require different configuration parameters.
          </DialogDescription>
        </DialogHeader>
