    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={handleRefresh} disabled={isRefetching || refreshing} variant="outline" size="sm" onMouseUp={() => notifyInfo("Refresh triggered", "Latest client state will sync to the list") }>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent><div className="text-2xl font-bold">{clients.length}</div><CardDescription>discovered</CardDescription></CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-sm">Detected</CardTitle></CardHeader>
          <CardContent><div className="text-2xl font-bold">{detectedCount}/{clients.length}</div><CardDescription>installed</CardDescription></CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-sm">Managed</CardTitle></CardHeader>
          <CardContent><div className="text-2xl font-bold">{managedCount}</div><CardDescription>management enabled</CardDescription></CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2"><CardTitle className="text-sm">Configured</CardTitle></CardHeader>
          <CardContent><div className="text-2xl font-bold">{configuredCount}</div><CardDescription>has MCP config</CardDescription></CardContent>
        </Card>
      </div>
